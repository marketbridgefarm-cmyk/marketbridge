    ...
    <main className="section">
      <div className="container-narrow">
        <div className="card" style={{ textAlign: 'center', padding: '40px 24px' }}>
          ...
          {status === 'PAID' && (<><h2>Payment confirmed ✓</h2><p className="muted">Your payment has been verified and recorded.</p></>)}
          {status === 'PENDING' && (<><h2>Payment pending</h2><p className="muted">Chapa hasn't confirmed this payment yet. If you completed checkout, this usually clears within a minute — refresh this page to check again.</p><button className="btn btn-light" onClick={() => window.location.reload()}>Check again</button></>)}
